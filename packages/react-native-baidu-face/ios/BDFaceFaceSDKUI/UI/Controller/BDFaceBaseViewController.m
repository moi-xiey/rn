...
- (void)loadView {
    [super loadView];
    self.data = @{@"success": @NO, @"code": @1000};
}
...
- (void)viewDidLoad {
    ...
    _timeOutImageView.image = [BDFaceImageUtils getImageResourceForName:@"icon_overtime"];
    ...
    [backButton setImage:[BDFaceImageUtils getImageResourceForName:@"icon_titlebar_close"] forState:UIControlStateNormal];
    ...
    _voiceImageView.animationImages = [NSArray arrayWithObjects:
                                       [BDFaceImageUtils getImageResourceForName:@"icon_titlebar_voice1"],
                                       [BDFaceImageUtils getImageResourceForName:@"icon_titlebar_voice2"], nil];
    ...
    if (soundMode.boolValue){
        ...
        _voiceImageView.image = [BDFaceImageUtils getImageResourceForName:@"icon_titlebar_voice_close"];
    }
    ...
    logoImageView.image = [BDFaceImageUtils getImageResourceForName:@"bg_bottom_pattern"];
