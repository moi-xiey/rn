...
//    [self.view addSubview:liveScoreLabel];
    ...
    [btnFirst setImage:[BDFaceImageUtils getImageResourceForName:@"btn_main_normal"] forState:UIControlStateNormal];
    ...
    [btnSecond setImage:[BDFaceImageUtils getImageResourceForName:@"btn_less_normal"] forState:UIControlStateNormal];
