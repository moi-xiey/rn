...
- (void)viewDidLoad {
    ...
    [backButton setImage:[BDFaceImageUtils getImageResourceForName:@"icon_titlebar_back"] forState:UIControlStateNormal];
    ...
    UIImage *backSelectImage = [BDFaceImageUtils getImageResourceForName:@"icon_live_list"];
    ...
    // 质量控制部分
    {
        ...
        rightArrow.image = [BDFaceImageUtils getImageResourceForName:@"right_arrow"];
    ...
    for (int i = 0; i < 7; i++){
        ...
        if (i == 0) {
            ...
            if([BDFaceLivingConfigModel.sharedInstance.liveActionArray containsObject:@(i-1)]){
                ...
                [buttonView setImage:[BDFaceImageUtils getImageResourceForName:@"icon_check_select"] forState:UIControlStateSelected];
            } else {
                buttonView.selected = NO;
                [buttonView setImage:[BDFaceImageUtils getImageResourceForName:@"icon_check"] forState:UIControlStateNormal];
            }
    ...
    self.warningView.image = [BDFaceImageUtils getImageResourceForName:@"icon_notice"];
...
- (IBAction)liveEyeAction:(UIButton *)sender {
    sender.selected ^= 1;
    if (sender.selected) {
        [sender setImage:[BDFaceImageUtils getImageResourceForName:@"icon_check_select"] forState:UIControlStateSelected];
        ...
        [sender setImage:[BDFaceImageUtils getImageResourceForName:@"icon_check"] forState:UIControlStateNormal];
