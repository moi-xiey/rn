...
- (void)resetPlusAndMinusButtons {
    ...
    if (currentValue.floatValue == minValue.floatValue) {
        [self.leftButton setImage:[BDFaceImageUtils getImageResourceForName:@"left_button_unable"] forState:UIControlStateNormal];
        [self.leftButton setImage:[BDFaceImageUtils getImageResourceForName:@"left_button_unable"] forState:UIControlStateHighlighted];
    } else {
        [self.leftButton setImage:[BDFaceImageUtils getImageResourceForName:@"left_button_normal"] forState:UIControlStateNormal];
        [self.leftButton setImage:[BDFaceImageUtils getImageResourceForName:@"left_button_highlight"] forState:UIControlStateHighlighted];
    }
    
    if (currentValue.floatValue == maxValue.floatValue) {
        [self.rightButton setImage:[BDFaceImageUtils getImageResourceForName:@"right_button_unable"] forState:UIControlStateNormal];
        [self.rightButton setImage:[BDFaceImageUtils getImageResourceForName:@"right_button_unable"] forState:UIControlStateHighlighted];
    } else {
        [self.rightButton setImage:[BDFaceImageUtils getImageResourceForName:@"right_button_normal"] forState:UIControlStateNormal];
        [self.rightButton setImage:[BDFaceImageUtils getImageResourceForName:@"right_button_highlight"] forState:UIControlStateHighlighted];
    }
}
