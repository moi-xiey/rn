...
- (void)setRadioState:(BOOL)radioState {
    ...
    if (radioState) {
        [self setImage:[BDFaceImageUtils getImageResourceForName:BDFaceSelectRadioSelectedImage] forState:UIControlStateNormal];
    } else {
        [self setImage:[BDFaceImageUtils getImageResourceForName:BDFaceSelectRadioUnselectedImage] forState:UIControlStateNormal];
    }
}
