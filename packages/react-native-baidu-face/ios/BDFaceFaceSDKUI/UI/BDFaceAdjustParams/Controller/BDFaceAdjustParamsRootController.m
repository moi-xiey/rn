...
- (void)loadTitleView {
    ...
    self.titleSeperator = [[UIView alloc] initWithFrame:CGRectMake(0, CGRectGetMaxY(_titleLabel.frame) - titleSeperatorHeight, [BDFaceCalculateTool screenWidth], titleSeperatorHeight)];
    ...
    [self.goBackButton setImage:[BDFaceImageUtils getImageResourceForName:@"icon_titlebar_back"] forState:UIControlStateNormal];
    [self.goBackButton setImage:[BDFaceImageUtils getImageResourceForName:@"icon_titlebar_back_p"] forState:UIControlStateHighlighted];
