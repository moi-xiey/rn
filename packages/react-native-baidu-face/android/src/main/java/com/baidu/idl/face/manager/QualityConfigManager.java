...
public class QualityConfigManager {
    ...
    private static com.baidu.idl.face.manager.QualityConfigManager instance;

    private QualityConfig mQualityConfig;

    public static com.baidu.idl.face.manager.QualityConfigManager getInstance() {
        if (instance == null) {
            synchronized (com.baidu.idl.face.manager.QualityConfigManager.class) {
                if (instance == null) {
                    instance = new com.baidu.idl.face.manager.QualityConfigManager();
                }
            }
        }
        return instance;
